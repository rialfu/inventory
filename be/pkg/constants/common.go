...
const (
	...
	MESSAGE_FAILED_VALUE_NOT_UNIQUE   = "value not unique"
...
var (
	...
	ErrFailedParsingTypeData = errors.New("failed parsing type data")
	ErrValueNotUniq          = errors.New("value not unique")
)
