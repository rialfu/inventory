<template>
    <div>
        ...
        <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
            ...
            <NuxtLink :to="{ path: `/attribute/${id}/create`,}" class="bg-green-600 px-2 py-2 rounded text-gray-100">Create</NuxtLink>
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                ...
                <tr>
                    ...
                    <th class="px-6 py-3 bg-gray-50 dark:bg-gray-700 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Name Attribute Value</th>
                ...
                <tr v-for="(data, index) in showTable['attribute_value'] ?? []" :key="index">
